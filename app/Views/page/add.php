...
<?= $this->section('content') ?>
	...
	<div class="page__toolbar">
		...
		<div class="">
			<a href="<?= base_url('admin/users'); ?>" onclick="return confirm('Are you want to cancel this form?');" class="btn btn-sm btn-secondary" onclick="$('#publish').val(0);$('#addpage').submit();">Draft</a>
