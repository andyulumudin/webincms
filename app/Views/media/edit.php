...
<?= $this->section('content') ?>
	...
	<div class="page__content mt-10">
		...
		<input type="hidden" name="id" value="<?= $media['content_id']; ?>" />
		...
		<div class="d-flex justify-between">
			...
			<div class="card mb-20">
				<div class="card--body">
					<div class="field-group">
						...
						<input type="text" class="input-text input-block" name="title" value="<?= $media['content_title']; ?>" />
					</div>
					<div class="field-group">
						<label class="">Body</label>
						<textarea id="summernote" class="input-text editor" name="body"><?= $media['content_body']; ?></textarea>
					</div>
				</div>
			</div>
			...
			<div class="col-4-12 pl-20">
				...
				<div class="card mb-20">
					...
					<div class="card--body">
					<input type="text" class="input-text input-block" name="tags" value="<?= $media['content_tags']; ?>" />
					</div>
				</div>
			</div>
		</div>
